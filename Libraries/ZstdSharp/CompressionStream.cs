...
namespace ZstdSharp
{
    public class CompressionStream : Stream
    {
        ...
        public override async System.Threading.Tasks.Task FlushAsync(CancellationToken cancellationToken)
        ...
        private async System.Threading.Tasks.Task FlushInternalAsync(ZSTD_EndDirective directive,
